...
export class MinibannerComponent implements OnInit {
  ...
  Insert_homebanner_details() {
    if (this.img_path == '') {
      ...
      console.log(a);
      this._api.mini_banner_insert(a).subscribe(
        (response: any) => {
          console.log(response.Data);
  ...
  Edit_user_type_details() {
    ...
    if (this.img_path == '') {
      ...
      this._api.mini_banner_edit(a).subscribe(
        (response: any) => {
          console.log(response.Data);
  ...
  Deletecompanydetails(data) {
    ...
    console.log(a);
    this._api.mini_banner_delete(a).subscribe(
      (response: any) => {
        console.log(response.Data);
  ...
  filter_date() {
    if ( this.E_Date != undefined && this.S_Date != undefined) {
      ...
      console.log(a);
      this._api.mini_banner_filter_date(a).subscribe(
        (response: any) => {
          console.log(response.Data);
          this.rows = response.Data;
        }
