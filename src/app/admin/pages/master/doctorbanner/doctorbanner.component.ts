...
@Component({
  ...
  styleUrls: ['./doctorbanner.component.css']
})
export class DoctorbannerComponent implements OnInit {
  ...
  Insert_doctorbanner_details() {
    if (this.img_path == '') {
      ...
      console.log(a);
      this._api.doctorbanner_insert(a).subscribe(
        (response: any) => {
          console.log(response.Data);
  ...
  Edit_user_type_details() {
    ...
    if (this.img_path == '') {
      ...
      this._api.doctorbanner_edit(a).subscribe(
        (response: any) => {
          console.log(response.Data);
  ...
  Deletecompanydetails(data) {
    ...
    console.log(a);
    this._api.doctorbanner_delete(a).subscribe(
      (response: any) => {
        console.log(response.Data);
  ...
  filter_date() {
    if ( this.E_Date != undefined && this.S_Date != undefined) {
      ...
      console.log(a);
      this._api.doctorbanner_filter_date(a).subscribe(
        (response: any) => {
          console.log(response.Data);
          this.rows = response.Data;
        }
